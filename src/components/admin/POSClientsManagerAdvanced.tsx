...
import { 
  Search, Plus, UserPlus, Download, BarChart3, Calendar, TrendingUp,
  Eye, Edit, Trash2, Filter, SortAsc, SortDesc, Users, Star,
  ShoppingBag, CreditCard, Phone, Mail, MapPin, Award, Zap,
  RefreshCw, ExternalLink, ChevronRight, Activity
} from 'lucide-react';
import { 
  addPOSClient, 
  getPOSClients, 
  ...
  registrarVentaPOS
} from '../../services/pos-clients-service';
import { exportClientsToExcel, exportClientTemplate } from '../../services/excel-export';
import { POSClient } from '../../types/pos-client';
...
export function POSClientsManagerAdvanced({ isVisible }: POSClientsManagerProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (currentClient) {
        ...
        const newClient = await addPOSClient(formData);
